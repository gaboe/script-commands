...
# @raycast.title Default to Brave
# @raycast.mode silent
# @raycast.packageName Browser

# Optional parameters:
# @raycast.icon images/brave.png

# Documentation:
# @raycast.author Gabriel Ecegi
# @raycast.authorURL https://github.com/gaboe
# @raycast.description Set Brave as the default browser.
...
tell application "System Events"
	try
		...
		try
            ...
            else    # otherwise click button 2 to change the default browser to Brave.
                click button 2 of window 1 of process "CoreServicesUIAgent"
            end if
			log "Brave is now your default browser"
		on error
			log "Brave is already your default browser"
		end try
	on error
